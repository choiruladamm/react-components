    ...
    <div className="sideNavOuter">
      ...
      >
        ...
        <ul className="menuItems">
          ...
          <li className="menu">
            <div className="menuItemContainer">
              <HiOutlineDocumentText size={20} className="menuIcon" />
              <span className="menuText" style={divStyle}>
                Profile
              </span>
            </div>
          ...
          <li className="menu">
            <div className="menuItemContainer">
              <AiOutlineCalendar size={20} className="menuIcon" />
              <span className="menuText" style={divStyle}>
                Schedules
              </span>
            </div>
          ...
          <li className="menu">
            <div className="menuItemContainer">
              <TbDiscount2 size={20} className="menuIcon" />
              <span className="menuText" style={divStyle}>
                Promote
              </span>
            </div>
        ...
        <div className="theme" style={{ width: toggle ? "14rem" : "2rem" }}>
          {!toggle ? (
            <button className="collapseTheme btn">
              <BsSunFill />
            </button>
          ) : (
            <>
